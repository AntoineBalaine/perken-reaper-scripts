--[[
@description Shortcut Manager: a utility for managing shortcuts in the ImGui context
@version
  0.0.1
@author Perken
@provides
...
@about
    ...
    HOW TO USE:
    Follow the instructions in the code below (shortcutManager.lua)
    Or follow the demo script that I have included in the  lib folder `shortcut_list/lib/shortcutManager_demo.lua`
@links
...
local function ShortcutManager(ctx, actions_list, config_path)
    ...
    ---Display the pop-up where the user can record a shortcut
